  ...
  return (
    <div
      ...
      <Link to={"/"} onClick={()=>{menuItemClickHandler(false)}} ><img src={logo} alt="B/D" className="drop-shadow-c-gray scale-110 mx-5 mr-8  w-8" />
        ...
        <Link to={"mailto:daskumarbiman2020@gmail.com"}>
          <span className="flex flex-row items-center">
            ...
            &nbsp;&nbsp;<span className="text-[#6a6b6ddb] ">daskumarbiman2020gmail.com</span>
          </span>
          </Link>
        </div>
      ...
      <div
        ...
        ref={menuRef}>
        <Link to={"/works"}>
        <span onClick={menuItemClickHandler} className="menuu  flex flex-row items-center mx-2 cursor-pointer">
