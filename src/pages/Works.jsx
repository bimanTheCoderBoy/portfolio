    ...
    <div className='w-full flex flex-col mt-16 justify-center '>
      {
        <div className='flex flex-row  p-8 mx-10 rounded-lg max-lg:flex-wrap max-lg:justify-center justify-around md:pr-[5rem]'>
          ...
          <img src="https://www.rammaheshwari.com/assets/jpeg/dopefolio.jpeg" className='w-[40rem]' alt="" />
          </div>
          <div className='pl-12 pt-8'>
          <h2 className='font-extrabold font-roboto text-3xl text-[#2e2e2e] drop-shadow-lg mb-7'>Dopefolio</h2>
          <p className='max-w-[28rem] text-[1.1rem] text-deepg'>Dopefolio is a successf
            ul Open-Source project that I created which have been featured on some of the biggest tech sites like CSS-Tricks, Hostinger, etc & used by thousands of developers globally</p>
          ...
          <Link to={"#"}> 
          <div className='w-48 h-14 hover:-translate-y-2 bg-[#2e2e2e] text-zinc-200 flex justify-center items-center mt-6 rounded-md  shadow-lg shadow-slate-500 text-xl font-[600] font-roboto tracking-wide duration-200'> <span className='drop-shadow-lg '>Take a look</span></div> 
          </Link> 
          </div>
